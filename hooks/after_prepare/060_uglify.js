...
var cwd= process.cwd ();
var dependancyPath= path.join(cwd,'node_modules','cordova-uglify', 'node_modules');
var dependancyPath2=path.join(cwd,'node_modules','gulp-ng-annotate','node_modules')
var UglifyJS = require(path.join(dependancyPath,'uglify-js')) ;
var CleanCSS = require(path.join(dependancyPath,'clean-css'));
var ngAnnotate = require(path.join(dependancyPath,'ng-annotate'));
